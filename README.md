...
<p align="center">
  <img src="./assets/profile.jpg" width="150" alt="Jay Patel" />
</p>
...
🎓 I'm a **2nd Year Computer Engineering student** at **Dharmsinh Desai University, Nadiad**.
...
🚀 I enjoy participating in hackathons, solving real-world problems, and turning ideas into working products.

📚 Currently focused on strengthening my **Data Structures & Algorithms, backend development, and AI/ML skills**.
...
### 🛡️ [ComplyAI — AI Compliance Officer](https://github.com/JAY-PATEL-210/COMPLYAI)

An AI-powered governance and compliance platform designed to help organizations understand and manage AI-related regulations.
...
`React` `TypeScript` `Node.js` `Google Gemini AI`
...
`React` `Vite` `Tailwind CSS` `Python` `FastAPI` `Machine Learning` `Recharts`

---

### 🎓 [AcadRisk AI — Academic Risk Detection Platform](https://github.com/devkamani9313-lab/acadrisk-ai)

🏆 **Top 10 Finalist — LDCE Hackathon 2026**

An academic monitoring and early-intervention platform that identifies students who may be at risk of academic failure or dropout.

**Key Features**
- Multi-factor academic risk detection
...
<p align="center">
  <a href="https://github.com/JAY-PATEL-210?tab=repositories">
